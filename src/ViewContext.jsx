...
const ViewContext = React.createContext({
    members:[], loggedIn: false, changeLoginState: (value) => {}, 
    listCampaigns: () => {}, runningCampaigns: [], getBidders: () => {}, 
    bidders: [], getAccounting: () => {}, accounting: null, 
    getCount: (acc,name,tail) => {}, getNewCampaign: (name) => {}, getNewTarget: (name) => {},
    getNewRule: (name) => {}, reset: () => {},getDbCampaigns: () => {}, 
    campaigns: [], getNewCreative: (ctype,name) => {}, addNewCampaign: (e) => {}, 
    deleteCampaign: (id) => {}, getDbCampaign: (id) => {},listRules: () => {}, 
    rules: [], addNewRule: (e) => {}, getRule: (id) => {}, 
    deleteRule: (id) => {}, addNewTarget: (e) => {}, listTargets: async () => {}, 
    targets: [], getTarget: (id) => {}, deleteTarget: (id) => {},
    creatives: [], listCreatives: () => {}, addNewCreative: (e) => {}, 
    getCreative: (id, key) => {}, deleteCreative: (id,key) => {}, findCreativeByName: (name) => {},
    forceUpdate: () => {}, getReasons: (id) => {}, macroSub: (data) => {}, 
    listSymbols: () => {}, deleteSymbol: (name) => {}, listMacros: () => {}, getToken: (c,n,p,s) => {},
    ssp: null, changeSsp: (name) => {}, uri: null, changeUri: (name) => {}, 
    url: null, changeUrl: (name) => {}, bidtype: null, changeBidtype: (name) => {}, 
    bidvalue: null, changeBidvalue: (value) => {}, bidobject: null, 
    bidresponse: null, changeBidresponse: (value) => {}, nurl: null,
    changeNurl: (value) => {}, xtime: null, changeXtime: (value) => {}, setAdm: (name) => {}, 
    adm: null, changeAdm: (value) => {}, winsent: false, 
    changeWinsent: (value) => {}, sendCallback: (srvr) =>  {}, configureAwsObject: (obj) => {},
    querySymbol: (name,key) => {}, queryHazelcast: (name,key) => {},
    creativesAvailable: (customer,id) => {}, getCampaignNameById: (id) => {}, 
    getTargetNameById: (id) => {}, getCampaignNameByTargetId: (id) => {},
    getBudget: (campaign,creative,type) => {}, getValues: (campaign,creative,type) => {},
    user: null, getUser: async (username) => {}, setNewUser: (user) => {},
    deleteUser: (id) => {}, listUsers: (cid) => {}, listAffiliates: () => {}, 
    deleteAffiliate: (id) => {}, addNewUser: (user) => {}, addNewAffiliate: (af) => {}
});
...
export const  ViewContextProvider = (props) => {
  ...
  const viewContextValue = {
    members: members, loggedIn: loggedIn, changeLoginState: changeLoginState, 
    listCampaigns: listCampaigns, runningCampaigns: runningCampaigns, getBidders: getBidders, 
    bidders: bidders,getAccounting: getAccounting, accounting: accounting, 
    getCount: getCount, getNewCampaign: getNewCampaign, getNewTarget: getNewTarget, 
    getNewRule: getNewRule, reset: reset, getDbCampaigns: getDbCampaigns, 
    campaigns: campaigns, getNewCreative: getNewCreative, addNewCampaign: addNewCampaign, 
    deleteCampaign: deleteCampaign, getDbCampaign: getDbCampaign, listRules: listRules, 
    rules: rules, addNewRule: addNewRule, getRule: getRule, 
    deleteRule: deleteRule, addNewTarget: addNewTarget, listTargets: listTargets, 
    targets: targets, getTarget: getTarget, deleteTarget: deleteTarget,
    creatives: creatives, listCreatives: listCreatives, addNewCreative, 
    getCreative: getCreative, deleteCreative: deleteCreative, findCreativeByName: findCreativeByName,
    forceUpdate: forceUpdate, getReasons: getReasons, macroSub: macroSub, 
    listSymbols: listSymbols, deleteSymbol: deleteSymbol, listMacros: listMacros, 
    getToken: getToken, ssp: ssp, changeSsp: changeSsp, 
    uri: uri, changeUri: changeUri, url: url, 
    changeUrl: changeUrl, bidtype: bidtype, changeBidtype: changeBidtype, 
    bidvalue: bidvalue, changeBidvalue: changeBidvalue, bidobject: bidobject, 
    bidresponse: bidresponse, changeBidresponse: changeBidresponse, nurl: nurl, 
    changeNurl: changeNurl, xtime: xtime, changeXtime: changeXtime, 
    setAdm: setAdm, adm: adm, changeAdm: changeAdm, winsent: winsent, 
    changeWinsent: changeWinsent, sendCallback: sendCallback, configureAwsObject: configureAwsObject,
    querySymbol: querySymbol, queryHazelcast: queryHazelcast,
    creativesAvailable: creativesAvailable, getCampaignNameById: getCampaignNameById, 
    getTargetNameById: getTargetNameById, getCampaignNameByTargetId: getCampaignNameByTargetId,
    getBudget: getBudget, getValues: getValues, user: user, 
    getUser: getUser, setNewUser: setNewUser, deleteUser: deleteUser, 
    listUsers: listUsers, listAffiliates: listAffiliates, deleteAffiliate: deleteAffiliate, 
    addNewUser: addNewUser, addNewAffiliate: addNewAffiliate
  };
    ///////////////////////////
